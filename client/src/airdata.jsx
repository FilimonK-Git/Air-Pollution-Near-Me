  ...
  if (props.airData.placeName !== '') {
    ...
    return (
      <div className="outter">
        ...
        <table>
          <tbody>
            ...
            <tr>
              ...
              <td style={{'fontWeight': 'bold'}}><a href="https://www.epa.gov/criteria-air-pollutants/naaqs-table" target="_blank">EPA's Limit (Averaging time)</a></td>
            ...
            <tr>
              ...
              <td> <span class="good"></span> {(35-(props.airData.PM25)).toFixed(1)} ug/m3 less</td>
            </tr>
            ...
            <tr>
              ...
              <td> 70 ppb (8-hour) </td>
              <td> <span class="semi"></span> {(70-(props.airData.OZONE)).toFixed(1)} ppb less</td>
            </tr>
            ...
            <tr>
              ...
              <td> 35 ppm (1-hour) </td>
              <td> <span class="good"></span> {(35-(props.airData.CO)).toFixed(1)} ppm less</td>
            </tr>
            ...
            <tr>
              ...
              <td> <span class="good"></span> {(100-(props.airData.NO2)).toFixed(1)} ppb less</td>
            </tr>
            ...
            <tr>
              ...
              <td> 75 ppb (1-hour) </td>
              <td> <span class="good"></span> {(75-(props.airData.SO2)).toFixed(1)} ppb less</td>
            </tr>
        ...
        <InnerAir aqi={props.airData.AQI} worstAir={props.worstAir} worstFinder={props.worstFinder}/>
